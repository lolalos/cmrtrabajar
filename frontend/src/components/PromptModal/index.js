...
const PromptSchema = Yup.object().shape({
    ...
    prompt: Yup.string().min(50, "¡Muy corto!").required("Describa el entrenamiento para Inteligencia Artificial"),
    voice: Yup.string().required("Indique el modo de Voz"),
