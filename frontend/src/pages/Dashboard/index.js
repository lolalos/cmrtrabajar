        ...
        <div>
            <Container ref={pageToPrint} maxWidth="lg" className={classes.container}>
                <Grid container spacing={3} justifyContent="flex-end">
                        ...
                        <Grid item xs={12} sm={6} md={3}>
                            <Paper className={classes.card} elevation={4}>
                                <Grid container spacing={1} alignItems="center">
                                    ...
                                    <Grid item xs={4}>
                                        <StoreIcon className={classes.cardIcon} style={{ color: "#FFFFFF" }} />
                                    </Grid>
                                </Grid>
                            </Paper>
                        </Grid>
                    ...
                    {/* T.M. DE ESPERA */}
                    <Grid item xs={12} sm={6} md={3}>
                        <Paper className={classes.card} style={{ overflow: "hidden" }} elevation={6}>
                            <Grid container spacing={1} alignItems="center">
                                {/* Texto */}
                                <Grid item xs={8}>
                                    <Typography component="h3" variant="subtitle1" className={classes.cardTitle}>
                        ...
                        <div style={{ display: "flex", flexDirection: "row", gap: 8 }}>
                            ...
                            <Grid item xs={12} className={classes.alignRight}>
                                <ButtonWithSpinner
                                    ...
                                    onClick={() => {
                                        setVisibleButtonsWithPrint(false);
                                        setTimeout(() => handlePrint(null, () => pageToPrint.current), 500);
                                    }}
                                    variant="contained"
                                    color="primary"
                                >
